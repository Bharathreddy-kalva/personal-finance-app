      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8">
        ...
        >
          <div className="lg:hidden flex items-center gap-3 mb-12">
            ...
            <span className="text-xl font-bold tracking-tight text-foreground" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Vault</span>
          </div>
          ...
          <form onSubmit={(e) => { e.preventDefault(); navigate('/dashboard'); }} className="space-y-5">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-[12px] font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">First name</label>
                <input placeholder="Alex" className="w-full h-11 px-3.5 rounded-xl border border-input bg-background text-sm text-foreground outline-none focus:ring-2 focus:ring-ring/50 focus:border-primary/30 transition-all" />
              </div>
              <div>
                <label className="text-[12px] font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">Last name</label>
                <input placeholder="Chen" className="w-full h-11 px-3.5 rounded-xl border border-input bg-background text-sm text-foreground outline-none focus:ring-2 focus:ring-ring/50 focus:border-primary/30 transition-all" />
              </div>
            </div>
            <div>
              <label className="text-[12px] font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">Email</label>
              <input type="email" placeholder="alex@email.com" className="w-full h-11 px-3.5 rounded-xl border border-input bg-background text-sm text-foreground outline-none focus:ring-2 focus:ring-ring/50 focus:border-primary/30 transition-all" />
            </div>
            <div>
              <label className="text-[12px] font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">Password</label>
            ...
            <Button type="submit" className="w-full h-11 rounded-xl active:scale-[0.98] transition-transform font-semibold">
              Create Account
            </Button>
          </form>
